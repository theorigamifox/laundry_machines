<?php
	function startProcessor($orderNumber) {
		...
		$gatewayOptions = retrieveGatewayOptions("VERISIGN_USA");
		
		$callBack = "$jssStoreWebDirHTTP"."gateways/response/verisign_usa.php";
		...
		$gArray["method"] = "POST";
		$gArray["action"] = "https://payments.verisign.com/payflowlink.cfm";
