<?php
	...
	$submitButton = "Update Country Settings";
?>
<HTML>
<HEAD>
<TITLE></TITLE>
...
<input type="hidden" name="xType" value="countries">
...
<table cellpadding="2" cellspacing="0">
	<tr>
		<td>
			<font class="normaltext"><b>Unavailable Countries:</b></font><br>
			<select name="xCountrySelect" size="10" class="form-inputbox" style="width:150px;" MULTIPLE>
<?php
		$result = $dbA->query("select * from $tableCountries where visible='N' order by name");
