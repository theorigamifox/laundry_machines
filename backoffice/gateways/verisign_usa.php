...
<table cellpadding="2" cellspacing="0" class="table-list">
	...
	<tr>
		<td class="table-list-title" valign="top">URLs For Verisign USA</td>
		<td class="table-list-entry1" valign="top">
		Return URL: <?php print $jssStoreWebDirHTTP."gateways/response/verisign_usa_return.php"; ?>
		<br>Silent POST URL: <?php print $jssStoreWebDirHTTP."gateways/response/verisign_usa.php"; ?>
		</td>
	</tr>
	<tr>
