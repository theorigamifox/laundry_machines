...
if(isset($_POST['redirect']))
{
	...
	{
		$redirect = 'http://www.laundrymachines.co.uk/page.php?xPage=contactsent.html';
	}

// for ultimate security, use this instead of using the form
$recipient = "sales@laundrymachines.co.uk"; // youremail@domain.com
...
// reside on.
$referers = array('laundrymachines.co.uk', 'ipsowashingmachines.com', 'carehomelaundry.com', 'commercialwashingmachines.co.uk', 'equinewash.co.uk', 'industriallaundrymachines.co.uk', 'laundrydryers.co.uk');
...
// send it off
// SOMETHING IS SPAMMING THROUGH THIS SO DON'T SEND IF SUBJECT HASN'T BEEN SET
if($subject != '')
{
